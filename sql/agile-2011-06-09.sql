...
INSERT INTO `agiledata`.`agile_pages` VALUES  (1,'/agregados/[A-Z 0-9]{10}/[A-Z]{3}[0-9]{4}','ActionAgregados'),
 (2,'/baseleilao/[A-Z 0-9]{10}/[A-Z]{3}[0-9]{4}','ActionBaseLeilao'),
...
CREATE TABLE  `agiledata`.`agile_usuarios` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `serial` varchar(10) CHARACTER SET latin1 NOT NULL,
  `update` varchar(20) CHARACTER SET latin1 NOT NULL,
...
INSERT INTO `agiledata`.`agile_usuarios` VALUES  (1,'A5T6J8G9X0','09/06/2011 11:13:02',1);
UNLOCK TABLES;
